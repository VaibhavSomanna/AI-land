"""
Alternating Bicep Curl exercise tracker.
"""
...
class AlternatingBicepCurlTracker(ExerciseTracker):
    """Tracker for alternating bicep curl exercise."""
    
    def __init__(self, tts_engine: TTSEngine):
        super().__init__("Alternating Bicep Curl", tts_engine)
    ...
    def detect_exercise(self, landmarks: Dict, image: np.ndarray) -> Tuple[bool, str]:
        ...
        if self.current_arm == "left":
            if (self.left_stage == "initial" and 
                ...
                feedback = "Start position detected for left arm. Curl your arm!"
                ...
                self.reps += 1
                rep_completed = True
                feedback = f"Left arm curl completed! Total reps: {self.reps}. Switch to right arm."
        ...
        # Right arm logic  
            ...
            if (self.right_stage == "initial" and 
                ...
                feedback = "Start position detected for right arm. Curl your arm!"
                self.feedback_given = False
                ...
                self.reps += 1
                rep_completed = True
                feedback = f"Right arm curl completed! Total reps: {self.reps}. Switch to left arm."
